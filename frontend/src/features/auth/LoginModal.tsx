      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-sm font-bold text-white mb-4">{t('auth.loginTitle')}</h2>
            ...
            <div className="mt-3">
              <button disabled className="w-full px-4 py-2 rounded-lg bg-white/5 text-slate-500 text-xs font-bold border border-white/5 cursor-not-allowed">
                Google
              </button>
            </div>
